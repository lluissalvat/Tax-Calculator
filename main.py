...
def incomeTaxPayment (yearly_income) :
  if yearly_income < inctax_thres1 :
    income_tax_payment = 0
  elif yearly_income >= inctax_thres1 and yearly_income < inctax_thres2 :
    income_tax_payment = (yearly_income - inctax_thres1) * 0.2
  elif yearly_income >= inctax_thres2 and yearly_income < inctax_thres3 :
    income_tax_payment = (inctax_thres2 - inctax_thres1) * 0.2 + (yearly_income - inctax_thres2) * 0.4
  elif yearly_income >= inctax_thres3 :
    income_tax_payment = (inctax_thres2 - inctax_thres1) * 0.2 + (yearly_income - inctax_thres3) * 0.45 + (inctax_thres3 - inctax_thres2) * 0.4
